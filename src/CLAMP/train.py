...
# SAVE_DIR = "saved_models/" + MODE + "_gatortronS40"
# SAVE_DIR = "saved_models/" + MODE + "_bio_discharge40"
# SAVE_DIR = "saved_models/" + MODE + "_BioMegatron40"
# SAVE_DIR = "saved_models/" + MODE + "_BioMed40"
# SAVE_DIR = "saved_models/" + MODE + "_BioMed_Large40"
SAVE_DIR = "saved_models/" + MODE + "_bio_clinical40"
# SAVE_DIR = "saved_models/" + MODE + "_gatortronBase40"
...
for FOLD in range(NUM_FOLD):
    ...
    raw_datasets = load_dataset(f"load_folds/fold{FOLD}.py", trust_remote_code = True)
